...
function MidSection2() {
  return (
    <div className="w-full md:h-[400px] sm:mt-[250px] flex md:flex-row sm:flex-col items-end md:justify-between sm:justify-start   bg-[--very-dark-gray-blue] rounded-tr-[90px] rounded-bl-[90px]  relative ">
      <div className=" md:w-[800px] sm:w-[470px]  md:h-[400px] overflow-hidden  sm:mb-[40px] ">
        <img
          className=" w-full  object-cover  md:scale-125 sm:scale-190 sm:ml-[56px]  sm:pb-[260px] sm:w-[80%] md:-ml-[107px]  md:pt-2  md:pb-[3000px]  "
          src={circles}
          alt="/"
        />
      </div>
      ...
      <div className=" flex flex-col justify-center absolute sm:mt-[0]  sm:m-[50px] sm:text-center sm:items-center sm:top-[40%] md:top-[30%] md:left-[48%] gap-9 sm:z-10 ">
        <h1 className="text-5xl  text-[--white] font-semibold  top-[20px] font-Overpass ">
          State of the Art Infrastructure
        </h1>
        <p className="md:w-[75%] text-[--white] leading-7 sm:text-xl  md:text-base font-Overpass ">
