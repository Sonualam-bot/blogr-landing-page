...
function HamburgerMenu() {
  ...
  return (
    <div className=" w-[80%]  bg-[--white]  text-[--very-dark-gray-blue]  absolute top-[120px]  left-8 rounded-lg p-6 flex flex-col items-center justify-start gap-10 text-center shadow-xl z-10 ">
